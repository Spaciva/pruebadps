        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-warning text-dark">
                    <h4 class="mb-0"><i class="bi bi-pencil"></i> Editar Libro</h4>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="index.php?page=libros&action=process-edit">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="titulo" name="titulo" class="form-control" value="<?= Security::escape($libro['titulo']) ?>" required minlength="3">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="autor_id" class="form-label"><i class="bi bi-pen"></i> Autor</label>
                                ...
                                <select id="categoria_id" name="categoria_id" class="form-select" required>
                                    ...
                                    <?php foreach ($categorias as $categoria): ?>
                                        <option value="<?= $categoria['id'] ?>" <?= $categoria['id'] == $libro['categoria_id'] ? 'selected' : '' ?>>
                                            <?= Security::escape($categoria['nombre']) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" id="cantidad" name="cantidad" class="form-control" value="<?= $libro['cantidad'] ?>" required min="0">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="estado" class="form-label"><i class="bi bi-info-circle"></i> Estado</label>
                                <select id="estado" name="estado" class="form-select">
                                    ...
                                    <option value="agotado" <?= $libro['estado'] === 'agotado' ? 'selected' : '' ?>>Agotado</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="descripcion" name="descripcion" class="form-control" rows="3"><?= Security::escape($libro['descripcion'] ?? '') ?></textarea>
                        </div>
